<section class="relative flex flex-col items-center w-full pt-2">
	...
	<h1
		class="mt-4 text-lg font-extrabold tracking-wide text-center text-transparent uppercase md:text-2xl bg-clip-text bg-gradient-to-r from-blue-500 to-orange-600"
	>
		create an account
	</h1>
</section>
